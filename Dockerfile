...
HEALTHCHECK --interval=1m --timeout=5s --retries=2 cmd mkdir -p /tmp/afptest && mount_afp afp://testuser:some_password@localhost/Test_Share /tmp/afptest && umount /tmp/afptest
